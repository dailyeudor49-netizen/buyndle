...
export const metadata: Metadata = {
  title: "Contact Us",
  description: "Get in touch with Buyndle for wholesale tech enquiries and quotes.",
};
              ...
              <form className="space-y-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500" />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <input type="email" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea rows={4} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500"></textarea>
                </div>
                <button type="submit" className="w-full py-2.5 bg-pink-600 text-white font-medium rounded-lg hover:bg-pink-500">
                  Send Message
                </button>
              </form>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-4">
                  {[
                    { t: "Email", v: "info@buyndle.com", d: "Response within 24 hours" },
                    { t: "Address", v: "56 Bahnhofstrasse, Zurich 8001", d: "Switzerland" },
                    { t: "Hours", v: "Monday - Friday", d: "9:00 AM - 6:00 PM CET" },
                  ].map((c, i) => (
                    <div key={i} className="p-4 bg-gray-50 rounded-lg">
                      <h3 className="font-semibold text-gray-900">{c.t}</h3>
                      <p className="text-pink-600">{c.v}</p>
